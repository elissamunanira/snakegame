           ...
           if(down)
 {
     snakeylength[0]=snakeylength[0]+25;
           ...
           if(snakexlength[0]>850)snakexlength[0]=25;
            ...
            collidesWithEnemy();            //gukura uko iriyye
            collidesWithBody();               //kwiruma
       repaint();
    ...
    private void collidesWithEnemy() {
      if(snakexlength[0]==enemyX && snakeylength[0]==enemyY){
          newEnemy();
          lengthOfSnake++;                                    //uko iriye uburebure  bwiyongere
          score++;
      }  
    }
    ...
    private void collidesWithBody() {
             for(int i=lengthOfSnake-1;i>=0;i--){
            if((i>4) && snakexlength[i]==snakexlength[0] && snakeylength[i]==snakeylength[0]){
              timer.stop();                  //MU GIHE YIRUMYE IZAJYE IHITA IHAGARARA 
              gameOver=true;
           }
